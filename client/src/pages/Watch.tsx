...
//   const src = `${process.env.REACT_APP_API_URL}/stream/${encodeURIComponent(filename)}`;
  ...
  return (
    <div className="bg-black min-h-screen">
      <ReactNetflixPlayer
        title={filename}
        subTitle={filename}
        src={src}  // หรือ /stream/movie.mkv
        //backButton={() => console.log("กลับหน้ารายการ")}
        //nextButton={() => console.log("เล่นตอนถัดไป")}
        autoPlay
        //startAt={0} // เริ่มต้นที่วินาทีที่ 0
      />
    </div>
  );
};
